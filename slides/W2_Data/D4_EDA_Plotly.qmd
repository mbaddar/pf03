...
## Comparing Confidence Intervals is "Weak"

A common mistake students make is to calculate a 95% CI for Country A and a 95% CI for Country B and see if they **overlap**.

* **The Overlap Rule**: If they don't overlap, they are definitely different.

* **The Problem**: If they do overlap, they might still be different.
...
::: callout-tip
If you only look at one country, you have a description. If you compare two countries, you have an experiment.
:::
...
* absolute diff
* relative diff (Such as a ratio) (Optional)
* sample sizes (n) 
